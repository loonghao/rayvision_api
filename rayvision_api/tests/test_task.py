...
def test_create_task(fixture_task, mock_requests):
    ...
    assert fixture_task._create_task()['taskIdList'] == [1658434]
    assert fixture_task._create_task()['aliasTaskIdList'] == ['2W1658434']
    assert fixture_task._create_task()['userId'] == 100093066
